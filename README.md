...
### 📚 The Journey
I am a passionate Full-Stack developer deep-diving into software development. Currently spending my days writing clean logic, designing beautiful user interfaces, and turning creative ideas into functional applications. 

*   **⚡ Frontend Focus:** Crafting modular components and fluid UI layouts.
*   **⚙️ Backend Focus:** Building structured REST APIs and robust database environments.
*   **🛠️ Tools & Workflow:** Testing endpoints thoroughly and managing version control efficiently.

</td>
<td width="40%" align="center" valign="middle">

<!-- LOFI STUDYING BOY ANIMATION -->
<img src="https://media3.giphy.com/media/v1.Y2lkPTc5MGI3NjExaTVtMDN2bzZzcm5zanB3b2lndnE4dDdldzZvZjNwbWVkdzg0bXZjaiZlcD12MV9pbnRlcm5hbF9naWZfYnlfaWQmY3Q9Zw/YOaLwgaAjmU4Ve5psK/giphy.gif" width="100%" style="border-radius: 8px;" alt="Lofi Boy Studying Code">
